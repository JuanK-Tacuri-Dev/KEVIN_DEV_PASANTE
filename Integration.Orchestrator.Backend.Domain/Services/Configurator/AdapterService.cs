...
namespace Integration.Orchestrator.Backend.Domain.Services.Configurator
{
        ...
        : IAdapterService<AdapterEntity>
    {
        ...
        public async Task<IEnumerable<AdapterResponseModel>> GetAllPaginatedAsync(PaginatedModel paginatedModel)
        {
        ...
        private async Task<Expression<Func<AdapterEntity, bool>>> ActiveStatusCriteria(Expression<Func<AdapterEntity, bool>> criteria) 
        {
