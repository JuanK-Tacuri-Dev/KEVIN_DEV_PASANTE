    ...
    public class MappingSynchronizationProfile : Profile
    {
        ...
        public MappingSynchronizationProfile()
        {
            ...
            CreateMap<SynchronizationStateResponseModel, SynchronizationStatusResponse>()
                .ForMember(dest => dest.Id, opt => opt.MapFrom(src => src.Id))
                .ForMember(dest => dest.status_key, opt => opt.MapFrom(src => src.synchronization_status_key))
                .ForMember(dest => dest.status_text, opt => opt.MapFrom(src => src.synchronization_status_text))
                .ForMember(dest => dest.status_color, opt => opt.MapFrom(src => src.synchronization_status_color))
                ...
                .ForMember(dest => dest.status_background, opt => opt.MapFrom(src => src.synchronization_status_background));
        }
