...
namespace Integration.Orchestrator.Backend.Application.Handlers.Administration.Synchronization
{
    public class SynchronizationStatusCommands
    {
        ...
        public readonly record struct UpdateSynchronizationStatusCommandRequest(SynchronizationStatusBasicInfoRequest<SynchronizationStatusUpdateRequest> SynchronizationStatus, Guid Id) : IRequest<UpdateSynchronizationStatusCommandResponse>;
        public readonly record struct UpdateSynchronizationStatusCommandResponse(SynchronizationStatusUpdateResponse Message);

        public readonly record struct DeleteSynchronizationStatusCommandRequest(SynchronizationStatusDeleteRequest SynchronizationStatus) : IRequest<DeleteSynchronizationStatusCommandResponse>;
        public readonly record struct DeleteSynchronizationStatusCommandResponse(SynchronizationStatusDeleteResponse Message);

        public readonly record struct GetByIdSynchronizationStatusCommandRequest(SynchronizationStatusGetByIdRequest SynchronizationStatus) : IRequest<GetByIdSynchronizationStatusCommandResponse>;
        public readonly record struct GetByIdSynchronizationStatusCommandResponse(SynchronizationStatusGetByIdResponse Message);

        public readonly record struct GetAllPaginatedSynchronizationStatusCommandRequest(SynchronizationStatusGetAllPaginatedRequest Synchronization) : IRequest<GetAllPaginatedSynchronizationStatusCommandResponse>;
