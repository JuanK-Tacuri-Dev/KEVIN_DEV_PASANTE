...
namespace Integration.Orchestrator.Backend.Domain.Tests.Services.Configurador
{
    public class EntitiesServiceTests
    {
        ...
        public async Task InsertAsync_ShouldThrowArgumentException_WhenDuplicateEntityExists()
        {
            ...
            _mockStatusService.Setup(service => service.GetByIdAsync(It.IsAny<Guid>())).ReturnsAsync(new StatusEntity());
            _mockEntitiesRepo.Setup(repo => repo.GetRepositoryAndNameExists(It.IsAny<EntitiesEntity>())).ReturnsAsync(true);
        ...
        public async Task CountEntitiesByNameAndRepositoryIdAsync_ShouldThrowException_WhenEntityAlreadyExists()
        {
            ...
            _mockEntitiesRepo.Setup(repo => repo.GetRepositoryAndNameExists(It.IsAny<EntitiesEntity>()))
                     .ReturnsAsync(true);
            ...
            _mockEntitiesRepo.Verify(repo => repo.GetRepositoryAndNameExists(It.IsAny<EntitiesEntity>()), Times.Once);
        }
    }
}
