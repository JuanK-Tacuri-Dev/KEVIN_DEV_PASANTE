...
namespace Integration.Orchestrator.Backend.Domain.Tests.Administration.Services
{
    public class EntitiesServiceTests
    {
        ...
        public EntitiesServiceTests()
        {
            ...
            _mockEntitiesService = new EntitiesService(_mockEntitiesRepo.Object, _mockCodeConfiguratorService.Object, _mockStatusService.Object);
        }
        ...
        public async Task InsertAsync_ShouldCallRepositoryInsertAsync_WhenValidationPasses()
        {
            ...
            _mockEntitiesRepo.Setup(repo => repo.InsertAsync(It.IsAny<EntitiesEntity>())).Returns(Task.CompletedTask);

            // Act
            await _mockEntitiesService.InsertAsync(newEntity);

            // Assert
            _mockEntitiesRepo.Verify(repo => repo.InsertAsync(It.IsAny<EntitiesEntity>()), Times.Once);
        ...
        public async Task UpdateAsync_ShouldCallRepositoryUpdateAsync_WhenValidationPasses()
        {
            ...
            _mockStatusService.Setup(service => service.GetByIdAsync(It.IsAny<Guid>())).ReturnsAsync(new StatusEntity());
            _mockEntitiesRepo.Setup(repo => repo.UpdateAsync(It.IsAny<EntitiesEntity>())).Returns(Task.CompletedTask);

            // Act
            await _mockEntitiesService.UpdateAsync(existingEntity);

            // Assert
            _mockEntitiesRepo.Verify(repo => repo.UpdateAsync(It.IsAny<EntitiesEntity>()), Times.Once);
        }
        ...
        public async Task DeleteAsync_ShouldCallRepositoryDeleteAsync()
        {
            ...
            _mockEntitiesRepo.Setup(repo => repo.DeleteAsync(It.IsAny<EntitiesEntity>())).Returns(Task.CompletedTask);

            // Act
            await _mockEntitiesService.DeleteAsync(entityToDelete);

            // Assert
            _mockEntitiesRepo.Verify(repo => repo.DeleteAsync(It.IsAny<EntitiesEntity>()), Times.Once);
        }
        ...
        public async Task InsertAsync_ShouldThrowArgumentException_WhenDuplicateEntityExists()
        {
            ...
            _mockStatusService.Setup(service => service.GetByIdAsync(It.IsAny<Guid>())).ReturnsAsync(new StatusEntity());
            _mockEntitiesRepo.Setup(repo => repo.GetByExits(It.IsAny<EntitiesEntity>())).ReturnsAsync(true);
            ...
            _mockEntitiesRepo.Verify(repo => repo.InsertAsync(It.IsAny<EntitiesEntity>()), Times.Never);
        }
        ...
        public async Task InsertAsync_ShouldThrowArgumentException_WhenCodeIsNotUnique()
        {
            ...
            _mockEntitiesRepo.Setup(repo => repo.GetByCodeAsync(It.IsAny<Expression<Func<EntitiesEntity, bool>>>())).ReturnsAsync(new EntitiesEntity());
        ...
        public async Task GetByIdAsync_ShouldReturnEntity_WhenEntityExists()
        {
            ...
            _mockEntitiesRepo.Verify(repo => repo.GetByIdAsync(It.IsAny<Expression<Func<EntitiesEntity, bool>>>()), Times.Once);
        }
        ...
        public async Task GetByTypeIdAsync_ShouldReturnEntities_WhenEntitiesExistForTypeId()
        {
            ...
            _mockEntitiesRepo.Setup(repo => repo.GetByTypeIdAsync(It.IsAny<Expression<Func<EntitiesEntity, bool>>>()))
            ...
            _mockEntitiesRepo.Verify(repo => repo.GetByTypeIdAsync(It.IsAny<Expression<Func<EntitiesEntity, bool>>>()), Times.Once); // Verifica que el repositorio fue llamado una vez
        }
        ...
        public async Task GetByRepositoryIdAsync_ShouldReturnEntities_WhenEntitiesExistForRepositoryId()
        {
            ...
            _mockEntitiesRepo.Setup(repo => repo.GetByRepositoryIdAsync(It.IsAny<Expression<Func<EntitiesEntity, bool>>>()))
                     .ReturnsAsync(entitiesList);

            // Act
            var result = await _mockEntitiesService.GetByRepositoryIdAsync(repositoryId);

            // Assert
            Assert.NotNull(result);  // Verifica que el resultado no es nulo
            Assert.Equal(entitiesList.Count, result.Count());  // Verifica que el número de entidades devueltas es el esperado
            _mockEntitiesRepo.Verify(repo => repo.GetByRepositoryIdAsync(It.IsAny<Expression<Func<EntitiesEntity, bool>>>()), Times.Once);  // Verifica que el repositorio fue llamado una vez
        }
        ...
        public async Task CountEntitiesByNameAndRepositoryIdAsync_ShouldThrowException_WhenEntityAlreadyExists()
        {
            ...
            _mockEntitiesRepo.Setup(repo => repo.GetByNameAndRepositoryIdAsync(It.IsAny<Expression<Func<EntitiesEntity, bool>>>()))
            ...
            Assert.Equal((int)ResponseCode.NotFoundSuccessfully, exception.Details.Code);
            Assert.Equal(AppMessages.Domain_EntityRepositoryExists, exception.Details.Description);

            // Verificar que el repositorio fue llamado correctamente
            _mockEntitiesRepo.Verify(repo => repo.GetByNameAndRepositoryIdAsync(It.IsAny<Expression<Func<EntitiesEntity, bool>>>()), Times.Once);
        }
    }
}
